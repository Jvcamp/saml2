...
# Creates metadata and returns it as a string of XML. The metadata has one POST assertion endpoint and a Redirect and POST LogoutService endpoint.
...
module.exports.ServiceProvider =
  class ServiceProvider
    ...
    #
    # @entity_id, @private_key, @assert_endpoint, @logout_endpoint, @certificate, @alt_private_keys, @alt_certs can
